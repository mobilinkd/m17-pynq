# ==============================================================
# File generated on Sun Jul 21 12:33:02 CDT 2019
...
## IP Info
set Vendor      "Mobilinkd"
set Library     "acg"
set IPName      "acg_top"
set Version     "1.0"
set DisplayName "Mobilinkd Arbitrary Clock Generator"
set Revision    "1907211233"
set Description "Arbitrary Clock Generator"
set Device      "zynq"
set AutoFamily  ""
set Taxonomy    "/VIVADO_HLS_IP"
set has_xpm_memory "0"
set sdx_kernel_name "acg_top"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. sdaccel]
set xo_hls_files_dir ""
set hdl_module_list {acg_top_AXILiteS_s_axi
acg_top
}
set kernel_xo ""
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 inc_V W 0x0 "Data signal of inc_V" {{0 32 inc_V W 0 "Bit 31 to 0 Data signal of inc_V"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"

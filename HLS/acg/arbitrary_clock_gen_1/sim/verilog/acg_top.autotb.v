...
`define AUTOTB_DUT      acg_top
`define AUTOTB_DUT_INST AESL_inst_acg_top
`define AUTOTB_TOP      apatb_acg_top_top
`define AUTOTB_LAT_RESULT_FILE "acg_top.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "acg_top.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_acg_top_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00

`define AESL_DEPTH_inc_V 1
`define AUTOTB_TVIN_inc_V  "../tv/cdatafile/c.acg_top.autotvin_inc_V.dat"
`define AUTOTB_TVIN_inc_V_out_wrapc  "../tv/rtldatafile/rtl.acg_top.autotvin_inc_V.dat"
`define AUTOTB_TVOUT_ap_return  "../tv/cdatafile/c.acg_top.autotvout_ap_return.dat"
`define AUTOTB_TVOUT_ap_return_out_wrapc  "../tv/rtldatafile/rtl.acg_top.autotvout_ap_return.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 10;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 0;
parameter LENGTH_inc_V = 1;

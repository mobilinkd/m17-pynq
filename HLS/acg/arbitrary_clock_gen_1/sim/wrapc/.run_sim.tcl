...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "acg_top.autotvin.dat"
	set constFileTvOut       "acg_top.autotvout.dat"
	set constFileHdlTvIn     "acg_top.autohdltvin.dat"
	set constFileHdlTvOut    "acg_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"

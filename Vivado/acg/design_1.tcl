...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set ja [ create_bd_port -dir O -from 0 -to 0 -type data ja ]

  # Create instance: acg_top_0, and set properties
  set acg_top_0 [ create_bd_cell -type ip -vlnv Mobilinkd:acg:acg_top:1.0 acg_top_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins acg_top_0/s_axi_AXILiteS] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net acg_top_0_clock_out_V [get_bd_pins acg_top_0/clock_out_V] [get_bd_pins selectio_wiz_0/data_out_from_device]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins acg_top_0/ap_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins selectio_wiz_0/clk_in]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins acg_top_0/ap_rst_n] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net selectio_wiz_0_data_out_to_pins [get_bd_ports ja] [get_bd_pins selectio_wiz_0/data_out_to_pins]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins acg_top_0/ap_start] [get_bd_pins xlconstant_0/dout]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs acg_top_0/s_axi_AXILiteS/Reg] SEG_acg_top_0_Reg
